const OPTIONS = [
  {
    ...
    accentClass: "border-accent/60 bg-accent/10",
    dotClass: "bg-accent",
  },
  {
    id: "mp4-480",
  ...
  },
  {
    ...
    accentClass: "border-danger/60 bg-danger/10",
    dotClass: "bg-danger",
  },
];
        ...
        return (
          <button
            ...
            className={`relative flex items-center gap-3 p-4 rounded-xl border transition-all duration-200 text-left
              ${isSelected ? opt.accentClass + " shadow-lg" : "border-white/10 bg-card hover:border-white/20 hover:bg-white/5"}
            `}
          >
